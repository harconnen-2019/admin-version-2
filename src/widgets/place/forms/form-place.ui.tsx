...
import { SelectTypeFromPlace } from '@/features/type-from-place';
...
interface IProperties {
  form: UseFormReturnType<placeTypes.CreatePlace> | UseFormReturnType<placeTypes.UpdatePlace>;
}
...
export function FormPlace({ form }: Readonly<IProperties>) {
   ...
   */
  const { getInputProps, setFieldValue, values } =
    form as UseFormReturnType<placeTypes.CreatePlace>;
      ...
      {segment === '1' && (
        <>
          <Group mt="md" align="flex-end">
            <SelectTypeFromPlace getInputProps={getInputProps('type')} />
